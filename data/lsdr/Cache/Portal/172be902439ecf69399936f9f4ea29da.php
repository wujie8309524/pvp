...
<link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/bull_vue-1.0.48.css">
...
<link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/public.css">
<link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/public128.css">
...
function operationButton(data){
  ...
  var html='';
    ...
    if(data=='2'){
        ...
        html+='              <img src="http://33ss.topwk.cn/app/img/bull9/bull_times_bg_blue1.png"  class="operationButton-gg11"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <img src="http://33ss.topwk.cn/app/img/bull9/btn_game_rule.png" class="bGameRule shier-bGameRule" onclick="opnemm('fangjian_gz','vroomRule')" /> 
...
">
   ...
   <div class="bottomMessage"  onclick="opnemm('fangjian_kj','message')">
    <img src="http://33ss.topwk.cn/app/img/bull9/bull_message.png" class='shier-bottomMessage-img'  />
   </div> 
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="http://33ss.topwk.cn/app/img/bull12/back.jpg" class="tableBack" /> 
 ...
 <div class="myCards" style="display: none;"></div>
    ...
    <div id="" class="clock shier-clock">
     <img src="http://33ss.topwk.cn/app/img/bull9/bull_clock.png" class='shier-memberCoin' /> 

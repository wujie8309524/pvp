...
.myButton .scoreList .scoreItem{width: 50px;height:54px;background:url("http://goss.fexteam.com/files/d_10/images/game/round.png");background-size:801px 95px;float: left;margin-left: 20px;}
...
.myButton .doubleButton .isOver .button{width: 50px;height:50px;background:url("http://goss.fexteam.com/files/d_10/images/game/round.png");background-size:801px 95px;}
...
.cardOver .back{background:url("http://goss.fexteam.com/files/common/images/cards.png");-webkit-transform:rotateY(-180deg);z-index: 91;background-size:389px 171px;box-shadow:1px 1px 5px #333;}
/*鐗岄潰瀹氫綅鏍峰紡*/
...
.myCards .back{background:url("http://goss.fexteam.com/files/common/images/cards.png");-webkit-transform:rotateY(-180deg);z-index: 91;background-size:519px 228px;box-shadow:1px 1px 5px #333;}
...
.ranking .rankText .scoresItem{width:129vw;margin:0 auto; margin-top: 10px;height:24vw;line-height:24vw;font-size:8vw;position: relative;background-color: #160f2b; }
...
.cardDeal .cardall{background:url("http://goss.fexteam.com/files/common/images/cards.png");z-index: 91;background-size:519px 228px;box-shadow:1px 1px 5px #333;}

<?php if (!defined('THINK_PATH')) exit();?><html>
 <head> 
  ...
  <title><?php echo ($titlexx); ?>卡包</title> 
...
<script>
  ...
  var shareimg = 'http://'+window.location.hostname+'/app/share_icon88.jpg';//分享的图片
...
<div class="main" style="">
  ...
  <img class='hb-bj' src="/themes/wdfms/Public/img/redpackage/redpackage_bg.jpg"> 
  
    <div class='hb-bj-1' id="notopen">
        <img class='hb-bj-img' src="/themes/wdfms/Public/img/redpackage/redpackage_new.png">
        ...
        <div class="btnOpen ling"  onclick="lingqufangka()">
            <img class='ling-img' src="/themes/wdfms/Public/img/redpackage/rp_get.png">
        </div> 
    ...
    <div id="ropen" class='hb-display-zt'>
        <img src="/themes/wdfms/Public/img/redpackage/redpackage_receive_new.png" class='hb-display-zt-img'>

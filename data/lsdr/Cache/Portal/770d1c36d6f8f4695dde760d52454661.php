<?php if (!defined('THINK_PATH')) exit();?><html>
 ...
 <div class='gameMenu-zt'>
          ...
          <div id="game1" class="gameListItem gameListItem3" >
           ...
           <div class="swiper-slide">
               ...
               <div id="game16" class="gameListItem gameListItem3" >
                   <img class='gameListItems' src="/themes/wdfms/Public/img/activity/rc_icon_9flowerwap.png" />
                   <div class='gameListItem-wz'>
                       九人金花
                   </div>
               </div>
     ...
     <div class="swiper-slide">
          ...
          <div id="game15" class="gameListItem gameListItem3" >
          ...
          <div class="swiper-slide" >
           ...
           <div class="swiper-slide" >
               ...
               <div id="game17" class="gameListItem gameListItem4" >
                   <img class='gameListItems' src="/themes/wdfms/Public/img/activity/jixiang.png"  />
                   <div class='gameListItem-wz'>
                       吉祥三公
                   </div>
               </div>

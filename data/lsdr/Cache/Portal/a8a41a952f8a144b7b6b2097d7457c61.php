<?php if (!defined('THINK_PATH')) exit();?><html>
 <head> 
  ...
  <link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/bull_vue-2.0.9988.css" /> 
  <link rel="stylesheet" type="text/css" href="/app/css/alert-1.1.8.css" /> 
  <link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/public18882.css">
...
function adduser(data){
    ...
    var html='<div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<img src="http://33ss.topwk.cn/images/chajian/y1.png" style="width: 100%;" />'
...
function operationButton(data){
    ...
    if(data=='7'){
        ...
        html+='<img class="operationButton-gg" src="http://33ss.topwk.cn/app/img/bull9/bull_button_blue.png"  /> ';
...
function randomString(len) {
  ...
  var title  = '新正华科技A';//分享的标题
  var shareimg = 'http://'+window.location.hostname+'/app/home.jpg';//分享的图片
  var shareimg = '';
...
<div id="valert2" class="alert">
  ...
  <div  class="main liurenniuniu"  style="height:100%;overflow: hidden;">
   ...
   <div class="roomCard">
    <img src="http://33ss.topwk.cn/app/img/game/roomCard.png" /> 
    <div class="num">
...
<style>
  .watch .mainPart{position: absolute;top: 42%;left: 50%; z-index: 100; margin-left:-22.5vh ;width: 45vh;background:url("http://33ss.topwk.cn/app/images/guanzhan/back88.png");background-size:100% 100%;border-radius: 1.5vh; height: 59vh;margin-top: -29.5vh}
  ...
  <div id="watch-list" class="watch" style="display: none;">
     ...
     <div class="mainPart">
         ...
         <div class="playerList"><div class="playerItem">
                    ...
                    <img src="http://33ss.topwk.cn/app/images/guanzhan/chajian/icon.png" class="playerIcon">
                </div></div>
   ...
   <img src="http://33ss.topwk.cn/app/img/game/home.png" class="return liurenniuniu-return"  onclick="opnemm('fangjian_fanhuisy','tishi')"/> 
   <img src="http://33ss.topwk.cn/app/img/common/note4.png" class="return liurenniuniu-return1"  onclick="opnemm('fangjian_tishi','tishi')"/>
   <img src="http://33ss.topwk.cn/app/img/common/footer_bull.png" usemap="#planetmap" class="bottom" /> 
   <img src="http://33ss.topwk.cn/app/img/common/icon_game_rule.png" class="bottomGameRule"   onclick="opnemm('fangjian_gz','vroomRule')"/> 
   <img src="http://33ss.topwk.cn/app/img/common/icon_sound61.png" class="bottomGameHistory"   onclick="opnemm('fangjian_yinyue','vaudioRoom')" /> 
   <img src="http://33ss.topwk.cn/app/img/common/icon_game_message.png" class="bottomGameMessage" onclick="opnemm('fangjian_kj','message')"/> 
   <img src="http://33ss.topwk.cn/app/images/guanzhan/watchButton.png" class="bottomGameMessage" style="right:70px"  onclick="showguanzhan()"/> 
...
<div id="messageSay">
  ...
  <div id='message' class="message" style="display: none;"></div> 
   ...
   <div id="table" class="table">
    <img src="http://33ss.topwk.cn/app/img/bull/table.jpg" class="tableBack" /> 
...
<div class="liurenniuniu-cardDeal">
   ...
   <div id="memberTimesText"></div> 
    ...
    <div id="" class="clock liurenniuniu-Text2">
     <img src="http://33ss.topwk.cn/app/img/bull/bull_clock.png" class='liurenniuniu-memberCoin' /> 
...
isguanzhan = 1;
  ...
  <?php if(count($room['userlist']) >= 6 && $room['userlist'][$user['id']] != 1): ?><div id="valert2" class="alert">
   <div>
   <img src="http://33ss.topwk.cn/app/fw_icon.png" style="position: absolute;right: 1vw;top: 0;height: 17.5vw;width: 21vw; z-index: 99;">
...
<?php else: ?>
   ...
   <div class="mainPart" style="margin-top: -162.365px;">
    ...
    <div class="id">
     <img src="http://33ss.topwk.cn/app/img/ID.png" /> 
     <div class="text">

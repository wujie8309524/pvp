...
<title><?php echo ($room["roomid"]); ?>号九人房间</title>
 ...
 <link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/bull_vue-2.0.3.8.css">
...
<link rel="stylesheet" type="text/css" href="http://33ss.topwk.cn/app/css/public1.css">
...
function operationButton(data){
    ...
    if(data=='2'){
        ...
        html+='              <img src="http://33ss.topwk.cn/app/img/bull9/bull_times_bg_blue.png"  class="operationButton-gg11"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <img src="http://33ss.topwk.cn/app/img/bull9/tab_bottom.png" alt="" class="tabBottom" /> 

   <div class="round jiurenniuniu-round" style="" id="jsxx">
    <?php echo ($room["js"]); ?>&nbsp;/&nbsp;<?php echo ($room["zjs"]); ?>局
   </div> 

   <img src="http://33ss.topwk.cn/app/img/bull9/btn_game_home.png" class="return"  onclick="opnemm('fangjian_fanhuisy','tishi')" /> 
   <!--<img src="http://33ss.topwk.cn/app/img/common/note5.png" class="return jiurenniuniu-return" onclick="opnemm('fangjian_tishi','tishi')"/> -->
   <img src="http://33ss.topwk.cn/app/img/bull9/btn_game_rule.png" class="bGameRule jiurenniuniu-bGameRule" onclick="opnemm('fangjian_gz','vroomRule')" /> 
...
">
   ...
   <div class="bottomMessage"  onclick="opnemm('fangjian_kj','message')">
    <img src="http://33ss.topwk.cn/app/img/bull9/bull_message.png" class='jiurenniuniu-bottomMessage-img'  />
   </div> 
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="http://33ss.topwk.cn/app/img/bull9/table.jpg" class="tableBack" /> 
 ...
 <div class="myCards" style="display: none;"></div>
    ...
    <div id="" class="clock jiurenniuniu-clock">
     <img src="http://33ss.topwk.cn/app/img/bull9/bull_clock.png" class='jiurenniuniu-memberCoin' /> 
